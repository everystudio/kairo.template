...
public class WarpPoint : MonoBehaviour
{
    ...
    [SerializeField] private WarpLocation target;
    [SerializeField] private WarpEvent warpRequest;
    ...
    [SerializeField, HideInInspector] private Collider2D boxCollider;
    [SerializeField, HideInInspector] private Rigidbody2D rigidBody;


#if UNITY_EDITOR

    [MenuItem("GameObject/2D Object/Utility/Warp Point")]
    static void CreateInteractionFieldObject()
    {
        GameObject newObject = new GameObject("Warp Point", typeof(WarpPoint));
    ...
    public void OnDrawGizmos()
    {
        ...
        {
            Bounds getBounds = GetComponent<Collider2D>().bounds;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            if (player.lastWarpLocation != target)
            {
                player.lastWarpLocation = target;
...
[CustomEditor(typeof(WarpPoint))]
public class SceneWarperInspector : Editor
{
    private WarpPoint warperReference;
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            warperReference = (target as WarpPoint);
        }
